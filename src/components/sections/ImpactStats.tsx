...
const stats = [
  {
    ...
    value: 90,
    suffix: "%",
    label: "Lulusan Langsung Kerja",
    description: "Dalam 6 bulan setelah wisuda",
  },
  {
    icon: Briefcase,
    value: 500,
    ...
    description: "Perusahaan mitra nasional & internasional",
  },
  {
    icon: Lightbulb,
    value: 100,
    ...
    description: "HAKI & paten terdaftar",
  },
  {
    icon: Award,
    value: 50,
    ...
    description: "Penghargaan kompetisi mahasiswa",
  },
];
